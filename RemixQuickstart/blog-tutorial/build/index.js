...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/root.jsx
var root_exports = {};
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/healthcheck.jsx
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/posts/$slug.jsx
var slug_exports = {};
__export(slug_exports, {
  default: () => PostSlug,
  loader: () => loader3
});
var import_node3 = require("@remix-run/node"), import_react3 = require("@remix-run/react"), loader3 = async ({ params }) => (0, import_node3.json)({ slug: params.slug });
function PostSlug() {
  let { slug } = (0, import_react3.useLoaderData)();
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/posts/index.tsx
var posts_exports = {};
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/posts/index.tsx
var loader4 = async () => (0, import_node4.json)({
  posts: await getPosts()
});
function Posts() {
  let { posts } = (0, import_react4.useLoaderData)();
  return console.log(posts), /* @__PURE__ */ React.createElement("main", null, /* @__PURE__ */ React.createElement("h1", null, "Posts"), /* @__PURE__ */ React.createElement("ul", null, posts.map((post) => /* @__PURE__ */ React.createElement("li", {
    key: post.slug
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/logout.jsx
var logout_exports = {};
...
var action = async ({ request }) => logout(request), loader5 = async () => (0, import_node5.redirect)("/");

// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/index.jsx
var routes_exports = {};
...
function useMatchesData(id) {
  let matchingRoutes = (0, import_react5.useMatches)(), route = (0, import_react6.useMemo)(() => matchingRoutes.find((route2) => route2.id === id), [matchingRoutes, id]);
...
function Index() {
  ...
  return /* @__PURE__ */ React.createElement("main", {
  ...
  }, user ? /* @__PURE__ */ React.createElement(import_react7.Link, {
    to: "/notes",
    ...
    to: "/join",
    className: "flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-base font-medium text-yellow-700 shadow-sm hover:bg-yellow-50 sm:px-8"
  }, "Sign up"), /* @__PURE__ */ React.createElement(import_react7.Link, {
    to: "/login",
  ...
  }, "Blog Posts")), /* @__PURE__ */ React.createElement("a", {
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/login.jsx
var login_exports = {};
...
var import_node6 = require("@remix-run/node"), import_react8 = require("@remix-run/react"), React2 = __toESM(require("react"));
var loader6 = async ({ request }) => await getUserId(request) ? (0, import_node6.redirect)("/") : (0, import_node6.json)({}), action2 = async ({ request }) => {
  ...
  return user ? createUserSession({
    ...
    redirectTo
  }) : (0, import_node6.json)({ errors: { email: "Invalid email or password" } }, { status: 400 });
}, meta2 = () => ({
  title: "Login"
});
function LoginPage() {
  ...
  }, /* @__PURE__ */ React2.createElement(import_react8.Form, {
    method: "post",
    className: "space-y-6"
  ...
  }, "Don't have an account?", " ", /* @__PURE__ */ React2.createElement(import_react8.Link, {
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/notes.jsx
var notes_exports = {};
...
function NotesPage() {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    to: "."
  }, "Notes")), /* @__PURE__ */ React.createElement("p", null, user.email), /* @__PURE__ */ React.createElement(import_react9.Form, {
    action: "/logout",
    method: "post"
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/notes/$noteId.jsx
var noteId_exports = {};
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/notes/index.jsx
var notes_exports2 = {};
...
function NoteIndexPage() {
  return /* @__PURE__ */ React.createElement("p", null, "No note selected. Select a note on the left, or", " ", /* @__PURE__ */ React.createElement(import_react11.Link, {
    to: "new",
    className: "text-blue-500 underline"
  }, "create a new note."));
}

// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/notes/new.jsx
var new_exports = {};
...
function NewNotePage() {
  ...
  }, [actionData]), /* @__PURE__ */ React3.createElement(import_react12.Form, {
    method: "post",
    style: {
      display: "flex",
...
// route:/Users/lagruni/Downloads/TestProjects/RemixQuickstart/blog-tutorial/app/routes/join.jsx
var join_exports = {};
...
var import_node10 = require("@remix-run/node"), import_react13 = require("@remix-run/react"), React4 = __toESM(require("react"));
var loader9 = async ({ request }) => await getUserId(request) ? (0, import_node10.redirect)("/") : (0, import_node10.json)({}), action5 = async ({ request }) => {
...
var assets_manifest_default = { version: "95c05be5", entry: { module: "/build/entry.client-2PGV5EHD.js", imports: ["/build/_shared/chunk-SXNZC6HP.js", "/build/_shared/chunk-O6YYFGCX.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-K5WUQO4K.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/healthcheck": { id: "routes/healthcheck", parentId: "root", path: "healthcheck", index: void 0, caseSensitive: void 0, module: "/build/routes/healthcheck-TKPENIUK.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/index": { id: "routes/index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/index-7JESFCNN.js", imports: ["/build/_shared/chunk-WAFFHMBX.js"], hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/join": { id: "routes/join", parentId: "root", path: "join", index: void 0, caseSensitive: void 0, module: "/build/routes/join-BHHQDJ3F.js", imports: ["/build/_shared/chunk-I6KLSYJ4.js", "/build/_shared/chunk-3UULGQSB.js", "/build/_shared/chunk-WAFFHMBX.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/login": { id: "routes/login", parentId: "root", path: "login", index: void 0, caseSensitive: void 0, module: "/build/routes/login-IEMTC3BA.js", imports: ["/build/_shared/chunk-I6KLSYJ4.js", "/build/_shared/chunk-3UULGQSB.js", "/build/_shared/chunk-WAFFHMBX.js"], hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/logout": { id: "routes/logout", parentId: "root", path: "logout", index: void 0, caseSensitive: void 0, module: "/build/routes/logout-AHKYY23H.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/notes": { id: "routes/notes", parentId: "root", path: "notes", index: void 0, caseSensitive: void 0, module: "/build/routes/notes-BHKZVLEK.js", imports: ["/build/_shared/chunk-BURPMA5Y.js", "/build/_shared/chunk-3UULGQSB.js", "/build/_shared/chunk-WAFFHMBX.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/notes/$noteId": { id: "routes/notes/$noteId", parentId: "routes/notes", path: ":noteId", index: void 0, caseSensitive: void 0, module: "/build/routes/notes/$noteId-W5BL37UM.js", imports: void 0, hasAction: !0, hasLoader: !0, hasCatchBoundary: !0, hasErrorBoundary: !0 }, "routes/notes/index": { id: "routes/notes/index", parentId: "routes/notes", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/notes/index-Z3TQHEEW.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/notes/new": { id: "routes/notes/new", parentId: "routes/notes", path: "new", index: void 0, caseSensitive: void 0, module: "/build/routes/notes/new-FIIRI5H7.js", imports: void 0, hasAction: !0, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/posts/$slug": { id: "routes/posts/$slug", parentId: "root", path: "posts/:slug", index: void 0, caseSensitive: void 0, module: "/build/routes/posts/$slug-7MQWIEFM.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/posts/index": { id: "routes/posts/index", parentId: "root", path: "posts", index: !0, caseSensitive: void 0, module: "/build/routes/posts/index-RNHHLQIH.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, url: "/build/manifest-95C05BE5.js" };
